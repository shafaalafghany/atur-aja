    ...
    <div class="container mx-auto pt-12 w-full items-start justify-center min-h-200">
        ...
        @foreach ($data as $item)
            <li class="item-li">
                ...
                <a href="/groups/edit-group/{{ $item['group_id'] }}" class="bg-yellow-400 rounded-full ml-4 font-bold text-white px-4 py-4 transition duration-300 ease-in-out hover:bg-yellow-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    </svg>
                </a>
                <a href="/groups/delete/{{ $item['group_id'] }}" class="bg-red-400 rounded-full ml-4 font-bold text-white px-4 py-4 transition duration-300 ease-in-out hover:bg-red-500">
