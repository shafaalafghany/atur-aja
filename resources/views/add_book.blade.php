...
<div class="min-h-200 pt-12 pb-40">
    ...
    <div class="leading-loose">
        <form action="/books/add/{{ $data }}" method="POST" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl mx-auto">
            ...
            <input type="submit" value="Tambahkan Buku Kas" class="block mt-10 mx-auto items-center bg-blue-400 rounded-full font-bold text-white px-3 py-2 transition duration-300 ease-in-out hover:bg-blue-500">
        </form>
    </div>
